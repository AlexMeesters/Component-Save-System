...
The version (1.071) on Github is free, however the newer version is [now paid and obtainable through the Unity Asset store.](https://assetstore.unity.com/packages/tools/utilities/component-save-system-159191?aid=1101lHUQ)
