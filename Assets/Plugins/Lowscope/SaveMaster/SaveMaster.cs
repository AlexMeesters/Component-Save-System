...
namespace Lowscope.Saving
{
     ...
     */
        ...
        public static void LoadSlot(int slot)
        {
            ...
            if (SaveSettings.Get().autoSaveOnExit && activeSaveGame != null)
            {
            ...
            {
                Debug.Log("Please set a default starting scene.");
                return;
            }
        ...
        /// </summary>
        public static void StartUpdating(Saveable saveable)
        {
        ...
        /// </summary>
        public static void StopUpdating(Saveable saveable)
        {
            if (saveable != null && activeSaveGame != null)
            {
        ...
        {
            SaveFileUtility.DeleteSave(activeSaveGame);
            activeSlot = -1;
            activeSaveGame = null;
        }
        ...
        private IEnumerator TrackOpenSlotMenu()
        {
            ...
            while (true)
            {
                ...
                if (Input.GetKeyDown(settings.openSlotMenuKey))
                {
                    if (instance == null)
                    {
